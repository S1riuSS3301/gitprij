...
export function DashboardSidebar() {
  ...
  return (
    <aside className="w-64 border-r border-border/50 bg-sidebar/50 backdrop-blur-sm hidden lg:block animate-fade-in">
        ...
        {menuItems.map((item, index) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "group w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 will-change-transform",
                isActive
