...
async function POST(request) {
    try {
        const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$lib$2f$auth$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuthUser"])();
        if (!auth) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Unauthorized'
        }, {
            status: 401
        });
        ...
        const tx = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].transaction.create({
            data: {
                userId: auth.userId,
                amount: parsed,
                currency,
            ...
            try {
                ...
                const res = await fetch(apiUrl, {
                    ...
                    headers: {
                        ...
                        'x-secret-key': process.env.LZT_MERCHANT_SECRET || ''
                    },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__94900ea3._.js.map