...
"[project]/Downloads/vds-hub/vds-hub/lib/db.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/Downloads/vds-hub/vds-hub/lib/prisma.ts [app-route] (ecmascript) <export prisma as db>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "db",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/vds-hub/vds-hub/lib/prisma.ts [app-route] (ecmascript)");
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/Downloads/vds-hub/vds-hub/lib/db.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__prisma__as__db$3e$__ = __turbopack_context__.i("[project]/Downloads/vds-hub/vds-hub/lib/prisma.ts [app-route] (ecmascript) <export prisma as db>");
;
;
;
;
...
async function getUser() {
    ...
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__prisma__as__db$3e$__["db"].user.findUnique({
        where: {
            id: authUser.userId
        },
        include: {
...
"[project]/Downloads/vds-hub/vds-hub/app/api/orders/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const orders = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__prisma__as__db$3e$__["db"].order.findMany({
            where: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(orders);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const plan = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__prisma__as__db$3e$__["db"].serverPlan.findUnique({
            where: {
                id: server_plan_id
            }
        });
        ...
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__prisma__as__db$3e$__["db"].order.create({
            data: {
                userId: authUser.userId,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(order);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b0373a8a._.js.map