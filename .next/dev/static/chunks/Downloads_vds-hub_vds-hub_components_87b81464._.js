...
function DashboardHeader() {
    ...
    // Store last loaded balance, used for checking new topup status without putting profile into effect deps
    const profileRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    profileRef.current = profile;
    // Load user/profile/orders once
    ...
    // Poll for recent top-ups; do not put object/array into deps!
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardHeader.useEffect": ()=>{
            const abortController = new AbortController();
            // Отдельная функция для проверки новых заявок на пополнение
            const checkTopUpStatus = {
                "DashboardHeader.useEffect.checkTopUpStatus": async ()=>{
                    try {
                        // Ожидается, что в /api/topups возвращается массив пополнений с полями status==OK, amount
                        const res = await fetch("/api/topups?recent=1", {
                            cache: "no-store",
                            signal: abortController.signal
                        });
                        if (!res.ok) return;
                        const topups = await res.json();
                        // Use profileRef for the latest balance state
                        if (Array.isArray(topups)) {
                            const okTopup = topups.find({
                                "DashboardHeader.useEffect.checkTopUpStatus.okTopup": (t)=>t.status === "OK" && !t.processed
                            }["DashboardHeader.useEffect.checkTopUpStatus.okTopup"]);
                            if (okTopup && profileRef.current) {
                                setProfile({
                                    "DashboardHeader.useEffect.checkTopUpStatus": (prev)=>prev ? {
                                            ...prev,
                                            balance: prev.balance + Number(okTopup.amount)
                                        } : prev
                                }["DashboardHeader.useEffect.checkTopUpStatus"]);
                                try {
                                    await fetch(`/api/topups/${okTopup.id}/mark-processed`, {
                                        method: "POST"
                                    });
                                } catch (e) {
                                    // Логируем, но не блокируем UX
                                    console.error("Mark topup as processed failed", e);
                                }
                            }
                        }
                    } catch (err) {
                    // Журналируем, но не бросаем ошибку
                    }
                }
            }["DashboardHeader.useEffect.checkTopUpStatus"];
            const interval = setInterval({
                "DashboardHeader.useEffect.interval": ()=>{
                    checkTopUpStatus();
                }
            }["DashboardHeader.useEffect.interval"], 10000);
            return ({
                "DashboardHeader.useEffect": ()=>{
                    abortController.abort();
    ...
    }["DashboardHeader.useEffect"], []); // <--- empty deps, runs only once
    if (!user) return null;
...
_s(DashboardHeader, "uHOERUrx6LxE0whamkoR1HAAP10=", false, function() {
    return [
...
"[project]/Downloads/vds-hub/vds-hub/components/billing/balance-card.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BalanceCard() {
    ...
    const [balance, setBalance] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BalanceCard.useEffect": ()=>{
            const currentUser = JSON.parse(localStorage.getItem("currentUser") || "{}");
            const profiles = JSON.parse(localStorage.getItem("profiles") || "[]");
            const userProfile = profiles.find({
                "BalanceCard.useEffect.userProfile": (p)=>p.userId === currentUser.id
            }["BalanceCard.useEffect.userProfile"]);
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: t("dashboard.billing") === "Billing" ? "Current Balance" : "Текущий баланс"
                                    }, void 0, false, {
                                        fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/balance-card.tsx",
                                        lineNumber: 29,
                                        columnNumber: 13
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: t("dashboard.billing") === "Billing" ? "Total Top-ups" : "Всего пополнений"
                            }, void 0, false, {
                                fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/balance-card.tsx",
                                lineNumber: 48,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-xs text-muted-foreground mb-1",
                                children: t("dashboard.billing") === "Billing" ? "Spent This Month" : "Потрачено за месяц"
                            }, void 0, false, {
                                fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/balance-card.tsx",
                                lineNumber: 54,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-xs text-muted-foreground mb-1",
                                children: t("dashboard.billing") === "Billing" ? "Average Spending" : "Средний расход"
                            }, void 0, false, {
                                fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/balance-card.tsx",
                                lineNumber: 60,
                                columnNumber: 11
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: [
                                    ...
                                    "/",
                                    t("dashboard.billing") === "Billing" ? "day" : "день"
                                ]
                            }, void 0, true, {
                                fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/balance-card.tsx",
                                lineNumber: 63,
...
_s(BalanceCard, "DHK7ZcHD3N7cmE8M4HuzQYJF5DQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$contexts$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"],
...
"[project]/Downloads/vds-hub/vds-hub/components/billing/payment-methods.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/vds-hub/vds-hub/hooks/use-toast.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$contexts$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/vds-hub/vds-hub/contexts/language-context.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
...
function PaymentMethods() {
    _s();
    const [amount, setAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const { addTransaction, refreshData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$contexts$2f$data$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useData"])();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const [cpEnabled, setCpEnabled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [balance, setBalance] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const { language } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$contexts$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"])();
    const paymentOptions = [
        {
            id: "crystalpay",
            name: language === "ru" ? "CrystalPay" : "CrystalPay",
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$smartphone$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Smartphone$3e$__["Smartphone"],
            description: language === "ru" ? "" : ".",
            fee: language === "ru" ? "до 5%" : "up to 5%"
        }
    ];
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PaymentMethods.useEffect": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                if (!cpEnabled) {
                    fetch("/api/config/payments", {
                        cache: "no-store"
                    }).then({
                        "PaymentMethods.useEffect": (r)=>r.json()
                    }["PaymentMethods.useEffect"]).then({
                        "PaymentMethods.useEffect": (cfg)=>setCpEnabled(Boolean(cfg?.crystalpayEnabled))
                    }["PaymentMethods.useEffect"]).catch({
                        "PaymentMethods.useEffect": ()=>setCpEnabled(false)
                    }["PaymentMethods.useEffect"]);
                }
                if (user && balance === 0) {
                    fetch("/api/profile", {
                        ...
                        "PaymentMethods.useEffect": (r)=>r.ok ? r.json() : null
                    }["PaymentMethods.useEffect"]).then({
                        "PaymentMethods.useEffect": (p)=>setBalance(typeof p?.balance === "number" ? p.balance : 0)
                    }["PaymentMethods.useEffect"]).catch({
                        "PaymentMethods.useEffect": ()=>setBalance(0)
                    }["PaymentMethods.useEffect"]);
                }
    ...
    const confirmCrystalPayment = async (id)=>{
        try {
            toast({
            ...
            toast({
                ...
                description: language === "ru" ? "Баланс обновлен" : "Balance updated"
            });
            // Refetch balance and data
    ...
    const handlePayment = async (method)=>{
        ...
        try {
            ...
            addTransaction({
                ...
                status: "pending",
                method: method,
                description: method === "crystalpay" ? language === "ru" ? `Пополнение через CrystalPay` : `Top-up via CrystalPay` : language === "ru" ? `Пополнение через LZT` : `Top-up via LZT`,
                type: "topup"
            });
            toast({
                title: language === "ru" ? "Инвойс создан!" : "Invoice created!",
                description: language === "ru" ? `Перенаправляем на оплату ${method === "crystalpay" ? "CrystalPay" : "LZT"}...` : `Redirecting to ${method === "crystalpay" ? "CrystalPay" : "LZT"}...`
            });
    ...
    const totalLzt = amt >= 10 ? `$${lztWithFee.toFixed(2)}` : "0.00";
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "card-gradient rounded-xl p-6 lg:p-8 border border-border/50",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                    className: "text-2xl font-bold text-foreground",
                    children: language === "ru" ? "Пополнить баланс " : "Top-up balance in US Dollars"
                }, void 0, false, {
                    fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/payment-methods.tsx",
                    lineNumber: 195,
                    columnNumber: 9
                }, this)
            }, void 0, false, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-xs text-muted-foreground",
                                children: "Минимальная сумма: $10.00 USD"
                            }, void 0, false, {
                                fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/payment-methods.tsx",
                                lineNumber: 240,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                children: language === "ru" ? "Оплата CrystalPay" : "Pay via CrystalPay "
                            }, void 0, false, {
                                fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/payment-methods.tsx",
                                lineNumber: 259,
                                columnNumber: 11
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                children: language === "ru" ? "Оплата LZT " : "Pay via LZT "
                            }, void 0, false, {
                                fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/payment-methods.tsx",
                                lineNumber: 266,
                                columnNumber: 11
...
_s(PaymentMethods, "rQQHltEyl3+voZ98piEbzTUFACY=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$contexts$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"]
    ];
});
_c = PaymentMethods;
...
"[project]/Downloads/vds-hub/vds-hub/components/billing/transaction-history.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TransactionHistory() {
    _s();
    const [items, setItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionHistory.useEffect": ()=>{
            let ignore = false;
            const load = {
                "TransactionHistory.useEffect.load": async ()=>{
                    try {
                        ...
                        if (!ignore) {
                            const mapped = data.map({
                                "TransactionHistory.useEffect.load.mapped": (t)=>({
                                        id: t.id,
                                        type: t.type,
                            ...
                            }["TransactionHistory.useEffect.load.mapped"]);
                            setItems(mapped);
                        }
                    } finally{
            ...
            }["TransactionHistory.useEffect.load"];
            load();
            return ({
                "TransactionHistory.useEffect": ()=>{
                    ignore = true;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                ...
                children: language === "ru" ? "История транзакций" : "Transaction history"
            }, void 0, false, {
                fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/transaction-history.tsx",
                lineNumber: 57,
                columnNumber: 7
            }, this),
            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "text-sm text-muted-foreground",
                children: language === "ru" ? "Загрузка…" : "Loading…"
            }, void 0, false, {
                fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/transaction-history.tsx",
                lineNumber: 62,
                columnNumber: 9
                ...
                className: "space-y-3",
                children: [
                    items.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "text-sm text-muted-foreground",
                        children: language === "ru" ? "Пока нет транзакций" : "No transactions yet"
                    }, void 0, false, {
                        fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/transaction-history.tsx",
                        lineNumber: 68,
                        columnNumber: 13
                    ...
                    items.map((t)=>{
                        const Icon = t.type === "deposit" ? __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$arrow$2d$up$2d$right$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ArrowUpRight$3e$__["ArrowUpRight"] : t.type === "referral" ? __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$gift$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Gift$3e$__["Gift"] : t.type === "withdrawal" ? __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$arrow$2d$down$2d$right$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ArrowDownRight$3e$__["ArrowDownRight"] : __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$server$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Server$3e$__["Server"];
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: t.description || (positive ? language === "ru" ? "Пополнение баланса" : "Balance top-up" : language === "ru" ? "Операция" : "Operation")
                                        }, void 0, false, {
                                            fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/transaction-history.tsx",
                                            lineNumber: 92,
                                            columnNumber: 19
                                        }, this),
                                        t.methodText && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-xs text-muted-foreground",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                t.status && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                    ...
                                                    children: t.status === "completed" ? language === "ru" ? "Завершено" : "Completed" : t.status === "pending" ? language === "ru" ? "В обработке" : "Pending" : language === "ru" ? "Ошибка" : "Failed"
                                                }, void 0, false, {
                                                    fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/transaction-history.tsx",
                                                    lineNumber: 104,
                                                    columnNumber: 23
...
_s(TransactionHistory, "kbwDhWLkvYysV9qDvxhHba/3ASI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$contexts$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"]
    ];
});
...
"[project]/Downloads/vds-hub/vds-hub/components/billing/billing-content.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/vds-hub/vds-hub/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$components$2f$billing$2f$balance$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/vds-hub/vds-hub/components/billing/balance-card.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$components$2f$billing$2f$payment$2d$methods$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/vds-hub/vds-hub/components/billing/payment-methods.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$components$2f$billing$2f$transaction$2d$history$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/vds-hub/vds-hub/components/billing/transaction-history.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$contexts$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/vds-hub/vds-hub/contexts/language-context.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/vds-hub/vds-hub/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
...
function BillingContent() {
    _s();
    const { t } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$contexts$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"])();
    // Автопуллинг после редиректа с провайдера: если есть ?tx=..., кратко опрашиваем данные
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BillingContent.useEffect": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            const url = new URL(window.location.href);
            const hasTx = url.searchParams.get("tx");
            if (!hasTx) return;
            let active = true;
            const until = Date.now() + 60_000 // 60s максимум
            ;
            const poll = {
                "BillingContent.useEffect.poll": async ()=>{
                    try {
                        // обновим профиль и историю (для UI компонентов, которые их читают)
                        await Promise.all([
                            fetch("/api/profile", {
                                cache: "no-store"
                            }),
                    ...
                    if (Date.now() < until) {
                        ...
                        // очистим параметр из URL
                        url.searchParams.delete("tx");
                        window.history.replaceState({}, "", url.toString());
                    }
                }
            }["BillingContent.useEffect.poll"];
            poll();
            return ({
                "BillingContent.useEffect": ()=>{
                    active = false;
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-muted-foreground",
                        children: t("dashboard.billing") === "Billing" ? "Manage your balance and payments" : "Управление балансом и платежами"
                    }, void 0, false, {
                        fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/billing-content.tsx",
                        lineNumber: 46,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$components$2f$billing$2f$payment$2d$methods$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/billing-content.tsx",
                lineNumber: 54,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$components$2f$billing$2f$transaction$2d$history$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TransactionHistory"], {}, void 0, false, {
                fileName: "[project]/Downloads/vds-hub/vds-hub/components/billing/billing-content.tsx",
                lineNumber: 55,
                columnNumber: 7
            }, this)
...
_s(BillingContent, "fTCcjqsdsNH+zmIKOnOeYND4Rxg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$vds$2d$hub$2f$vds$2d$hub$2f$contexts$2f$language$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"]
    ];
});
_c = BillingContent;
var _c;
__turbopack_context__.k.register(_c, "BillingContent");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Downloads_vds-hub_vds-hub_components_87b81464._.js.map