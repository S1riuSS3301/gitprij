...
### Многоязычность
- [x] Переключатель RU/EN в header
- [x] Файлы переводов (locales)
- [x] Обновление всех текстов

### Админка улучшения
- [x] Скрытие/отображение планов серверов для покупки (DDR4, DDR5 отдельно)

### Другое
- [x] FAQ страница
- [x] Тикеты поддержки
- [ ] Уведомления в браузере
- [x] Иконка TG новостей справа
- [ ] Фикс всех ошибок из логов терминала
